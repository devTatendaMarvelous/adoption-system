        ...
        <section class="main-slider">
            <div class="swiper-container thm-swiper__slider" data-swiper-options='{"slidesPerView": 1, "loop": true,
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="image-layer"
                            style="background-image: url(website/images/backgrounds/main-slider-1-2.jpg);"></div>
                        <div class="main-slider-shape-1"></div>
                        <div class="main-slider-shape-2"></div>
                        <div class="main-slider-shape-3 zoominout"></div>
                        <div class="main-slider-shape-4 zoominout-2"></div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="100ms">
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img">
                                <img src="website/images/project/project-1-1.jpg" alt="">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="200ms">
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img">
                                <img src="website/images/project/project-1-2.jpg" alt="">
                                <div class="project-one__content">
                                    <p class="project-one__sub-title">Our Best Projects</p>
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img">
                                <img src="website/images/project/project-1-3.jpg" alt="">
                                <div class="project-one__content">
                                    <p class="project-one__sub-title">Our Best Projects</p>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="300ms">
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img">
                                <img src="website/images/project/project-1-4.jpg" alt="">
                                <div class="project-one__content">
                                    <p class="project-one__sub-title">Our Best Projects</p>
                        ...
                        <div class="project-one__single">
                            <div class="project-one__img">
                                <img src="website/images/project/project-1-5.jpg" alt="">
                                <div class="project-one__content">
                                    <p class="project-one__sub-title">Our Best Projects</p>
