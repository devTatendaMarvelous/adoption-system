                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Edit Orphanage Details</h5>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm">
                                    <form class="needs-validation" novalidate action="{{ route('orphanages.update',[$orphanage->id]) }}"  method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-row">
                                            <div class="col-md-6 mb-3">
                                                <label for="validationCustom01"> Name</label>
                                                <input type="text" class="form-control" name="name" id="validationCustom01" placeholder="Orphanage Name" value="{{$orphanage->user->name}}" required>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" class="form-control" name="email" type="email" id="validationCustom01" value="{{$orphanage->user->email}}" placeholder="Email"  required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-4 mb-3">
                                                ...
                                                <input class="form-control" name="phone" id="validationCustom02" placeholder="Phone" value="{{$orphanage->phone}}"  required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                                <div class="invalid-feedback">
